"""Alembic migration environment for async SQLAlchemy + SQLite."""
...
from guidloc.auth import models as _auth_models  # noqa: F401
...
# Inject database URL from Settings (.env), so we keep a single source of truth.
...
# Models will be imported here as we add them, e.g.:
#   from guidloc.users import models
